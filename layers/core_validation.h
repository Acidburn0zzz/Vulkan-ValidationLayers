...
class CoreChecks : public ValidationStateTracker {
  public:
    ...
    bool ValidateDynamicOffsetAlignment(const VkDescriptorSetLayoutBinding* binding, VkDescriptorType test_type,
    ...
    bool ValidateDeviceMaskToRenderPass(const CMD_BUFFER_STATE* pCB, uint32_t deviceMask, VkCommandBuffer command_buffer,
                                        const char* VUID) const;
